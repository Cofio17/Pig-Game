...
const RollDiceRefactor = ()=>{
    ...
    if (randomNumber === 1) {
       resetCurrentScore();
        ...
        activeIndex === 0? scoreOne+=randomNumber:scoreTwo+=randomNumber; 
         }
    };
...
const HoldGameRefactor = ()=>{
    ...
    activeIndex === 0? playerOneScoreTotal.textContent = scoreTotalOne+=scoreOne: 
    playerTwoScoreTotal.textContent = scoreTotalTwo+=scoreTwo

    if(scoreTotalOne >= 50 || scoreTotalTwo >= 1500){
